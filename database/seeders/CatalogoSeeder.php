...
class CatalogoSeeder extends Seeder
{
    public function run(): void
    {
        DB::table('catalogo')->insert([
            ...
            ['codigo' => 2104, 'nombre' => 'DOCUMENTOS POR PAGAR', 'descripcion' => 'Obligaciones documentadas por pagar', 'naturaleza_id' => 3],
            ...
            ['codigo' => 2112, 'nombre' => 'CUENTAS POR PAGAR', 'descripcion' => 'Cuentas por pagar diversas', 'naturaleza_id' => 3],
            ...
            ['codigo' => 6102, 'nombre' => 'IVA', 'descripcion' => 'asdasdasd', 'naturaleza_id' => 3], //pasivo corriente iva por pagar
            ['codigo' => 6103, 'nombre' => 'COMPRAS TOTALES', 'descripcion' => 'asdasdasd', 'naturaleza_id' => 1], //Se llama cuentas
